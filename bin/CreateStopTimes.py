...
def create_stop_times(sheets, book, service_id):
    for sheet in sheets:
...
def main():
    week_workbook = xlrd.open_workbook(WEEK_FILE_NAME)
    holy_workbook = xlrd.open_workbook(HOLY_FILE_NAME)

    week_sheets_file = week_workbook.sheets()
    holy_sheets_file = holy_workbook.sheets()

    week_stop_times = create_stop_times(week_sheets_file, week_workbook, 'weekday')
    holy_stop_times = create_stop_times(holy_sheets_file, holy_workbook, 'holiday')
